...
function () {
    ...
    game.changeGameplayMode = function (b) {
        ...
        case 14:
            ...
            try {
                window.parent.postMessage({ type: 'PACMAN_GAME_OVER', score: game.score[0] }, '*');
            } catch(e) {}
            break;
        case 9:
            game.stopAllAudio();
    ...
    game.addToScore = function (b, c) {
        ...
        try {
            window.parent.postMessage({ type: 'PACMAN_SCORE_UPDATE', score: game.score[0] }, '*');
        } catch(e) {}
    };
    ...
    game.exportFunctionCalls = function () {
        ...
        google.pacman.getScore = function () { return game.score ? game.score[0] : 0; };
        google.pacman.getLives = function () { return game.lives; };
        google.pacman.newGame = game.newGame;
    };
